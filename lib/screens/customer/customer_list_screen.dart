              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Service Duration: ${DateFormat('dd/MM/yyyy').format(customer.serviceDurationStartDate)} - ${DateFormat('dd/MM/yyyy').format(customer.serviceDurationEndDate)}',
                      style: const TextStyle(fontSize: 14),
                    ),
                    const SizedBox(height: 5),
                    Text(
                      'Service: ${customer.selectedService}',
                      style: const TextStyle(fontSize: 14),
                    ),
                  ],
                ),
